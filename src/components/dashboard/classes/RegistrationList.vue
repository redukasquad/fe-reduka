...
// RegistrationList — approve/reject course registrations
...
const { data, isLoading, isError } = useQuery({
  queryKey: ['registrations', props.courseId],
...
const { mutate: approve, isPending: approving } = useMutation({
  ...
  onSuccess: () => {
    queryClient.invalidateQueries({ queryKey: ['registrations', props.courseId] })

...
<template>
  <div class="p-2 space-y-4">
    <div class="flex justify-between items-center">
        ...
        <RouterLink to="programs/create" class="px-4 py-2 md:font-medium md:text-lg text-sm font-semibold rounded-md bg-primary cursor-pointer text-primary-foreground hover:bg-primary/90 active:scale-95 transition-all duration-200">
            Tambah Program
        </RouterLink>
    </div>

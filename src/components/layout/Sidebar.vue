      ...
      <div class="p-4 border-t border-primary-foreground/10">
        <button
          ...
          :class="[
            ...
            tool.isSidebarOpen ? 'justify-start' : 'justify-center'
          ]"
        >
          <Icon icon="mdi:logout" class="text-xl shrink-0" />
          <span v-if="tool.isSidebarOpen" class="text-sm font-medium">Logout</span>
        </button>
      </div>
    </div>
  </aside>
